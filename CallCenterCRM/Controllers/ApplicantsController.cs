...
namespace CallCenterCRM
{
    public class ApplicantsController : Controller
    {
        ...
        {
            var callcentercrmContext = _context.Applicants.Include(a => a.CityDistrict).Include(a => a.Organization);
